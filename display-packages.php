		...
		<table cellpadding="0" cellspacing="0" border="0" width="731">
			...
			<tr>
				...
				<table cellpadding=0 cellspacing=0 border=0 width="559">
					<tr>
						<td align="right" width="368"><img src="images/sub-packagesandpricing.gif" alt="Packages &amp; Pricing" width="210" height="48" border="0"></td>
						<td width="6"><img src="images/spacer.gif" alt="" height="1" width="6"></td>
						<td width="186"><img src="images/sub-phototop2.jpg" alt="" width="186" height="48"></td>
					</tr>
				</table>
				</td>
			</tr>
					...
					<tr>
						...
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td class="content">
								<a href="customerservice/index.html"><img src="images/sub-customerservicehead.gif" alt="Customer Service" width="142" height="24" border="0"></a><br>
								<a href="checkemail.html">Check My Email</a><br>
								<a href="email-settings.html">Email Settings</a><br>
								Packages &amp; Pricing<br>
								<a href="support-contact.php">Contact Support</a><br>
								<a href="bill-explanation.html">Explanation of Bill</a><br>
								<br>
						...
						<table cellpadding="2" cellspacing="0" border="0" width="367">
							<tr>
								...
								<td class="content">
									<table cellpadding=0 cellspacing=1 border=0 width="353" bgcolor="#AAAAAA">
										<tr>
											...
											<table cellpadding=5 cellspacing=0 border=0 width="351" bgcolor="#FFFFE5">
												<tr>
													<td class="content" align="center"><b>Packages &amp; Pricing<br><?php echo $_COOKIE["vs-propertyname"] ?></b></td>
												</tr>
											</table>
											</td>
										</tr>
									...
									<center>
									<?php
									include("doServiceListing.php");
									 
									 
									if ((!$cableTable)&&(!$digitalTable)&&(!$internetTable))
									{
?>
<div align="left" class="content">
We're sorry, currently there is no Packages &amp; Pricing information available to <?php echo $_COOKIE["vs-propertyname"] ?> through our website.<br>
<br>
Please <a href="support-contact.php">contact us</a> for more information, or select a
<a href="newlocation.php">new location</a>. Thank you.
</div>
<?php
									} else {
										if ($cableTable)
										{
											print $cableTable . "<br><br>\n";
										}
									}
				...
				<img src="images/sub-photo2.jpg" alt="" width="186" height="272" border="0">
				</td>
			</tr>
		</table>
		</td>
