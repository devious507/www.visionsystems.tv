		...
		<table cellpadding="0" cellspacing="0" border="0" width="731">
			...
			<tr>
				...
				<table cellpadding=0 cellspacing=0 border=0 width="559">
					<tr>
						<td align="right" width="368"><img src="images/sub-signup-head.gif" alt="Sign Up" width="83" height="48" border="0"></td>
					...
					<tr>
						...
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<a href="products/internet-overview.html">Internet</a><br>
								<a href="products/telephony-overview.html">Telephony</a><br>
								<br>
						...
						<table cellpadding="2" cellspacing="0" border="0" width="367">
							<tr>
								...
								<table cellpadding=0 cellspacing=1 border=0 width="353" bgcolor="#AAAAAA">
									<tr>
										...
										<table cellpadding=5 cellspacing=0 border=0 width="351" bgcolor="#FFFFE5">
											<tr>
												<td class="content" align="center"><b>Sign Up</b></td>
											</tr>
										</table>
										</td>
									</tr>
								...
								Please complete the following form (required fields are <b><font color="#990000">in red</font></b>).
								Pricing and availability are subject to change, we will call you with final
								details and to schedule a service call.<br>
								<br>
								<center>
								<table cellpadding="0" cellspacing="5" border="0">
									<tr>
										<td class="required">First Name:</td>
										<td class="content"><input type="text" name="fname" size="30" class="input"></td>
									</tr>
									<tr>
										<td class="content">Middle Name:</td>
										<td class="content"><input type="text" name="mname" size="30" class="input"></td>
									</tr>
									<tr>
										<td class="required">Last Name:</td>
										<td class="content"><input type="text" name="lname" size="30" class="input"></td>
									</tr>
									<tr>
										<td class="required">Phone Number:</td>
										<td class="content"><input type="text" name="phone1" size="30" class="input"></td>
									</tr>
									<tr>
										<td class="content">Alternate Number:</td>
										<td class="content"><input type="text" name="phone2" size="30" class="input"></td>
									</tr>
									<tr>
										<td class="required">Address:</td>
										<td class="content"><input type="text" name="address" size="30" class="input"></td>
									</tr>
									<tr>
										<td class="content">Apt:</td>
										<td class="content"><input type="text" name="apt" size="30" class="input"></td>
									</tr>
									<tr>
										<td class="required">City:</td>
										<td class="content"><?php echo $_COOKIE["vs-city"]; ?></td>
									</tr>
									<tr>
										<td class="required">State:</td>
										<td class="content"><?php echo $_COOKIE["vs-state"]; ?></td>
									</tr>
									<tr>
										<td class="required">Community:</td>
										<td class="content"><?php echo $_COOKIE["vs-propertyname"]; ?></td>
									</tr>
									<tr>
										<td class="content" colspan="2">
										<br>
										<div class="required">Services Requested:</div>
										<?php include("doSignupListing.php"); ?><br>
										<center>
