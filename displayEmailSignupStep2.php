		...
		<table cellpadding="0" cellspacing="0" border="0" width="731">
			...
			<tr>
				...
				<table cellpadding=0 cellspacing=0 border=0 width="559">
					<tr>
						<td align="right" width="368"><img src="images/sub-internet.gif" alt="Internet" width="90" height="48" border="0"></td>
					...
					<tr>
						...
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td class="content">
								<a href="products/index.html"><img src="images/sub-productshead.gif" alt="Products" width="71" height="24" border="0"></a><br>
								<a href="products/cable-overview.html">Cable</a><br>
								<a href="products/digitalcable-overview.html">Digital Cable</a><br>
								<br>
								<b>Internet</b><br>
								<img src="images/spacer.gif" alt="" height="1" width="5"> <a href="products/internet-overview.html">Overview</a><br>
								<img src="images/spacer.gif" alt="" height="1" width="5"> <a href="products/internet-requirements.html">System Requirements</a><br>
								<img src="images/spacer.gif" alt="" height="1" width="5"> Check My Email<br>
								<img src="images/spacer.gif" alt="" height="1" width="5"> <a href="email-settings.html">Email Settings</a><br>
								<img src="images/spacer.gif" alt="" height="1" width="5"> <a href="webspace.html">Web Space</a><br>
								<img src="images/spacer.gif" alt="" height="1" width="5"> <a href="products/internet-speedtest.html">Speed Test</a><br>
								<img src="images/spacer.gif" alt="" height="1" width="5"> <a href="signup.php">Sign Up</a><br>
								<img src="images/spacer.gif" alt="" height="1" width="5"> <a href="products/internet-faq.html">FAQ</a><br>
								<br>
						...
						<table cellpadding="2" cellspacing="0" border="0" width="367">
							<tr>
								<td width="10"><img src="images/spacer.gif" alt="" height="1" width="10"></td>
								<td class="content">
								<table cellpadding=0 cellspacing=1 border=0 width="353" bgcolor="#AAAAAA">
									<tr>
										<td>
										<table cellpadding=5 cellspacing=0 border=0 width="351" bgcolor="#FFFFE5">
											<tr>
												<td class="content" align="center"><b>Account Setup</b></td>
											</tr>
										</table>
										</td>
									</tr>
								...
								<?php 
								if($ok) {
									print "<div class=\"required\"><b>$ok</b></p>\n";
								}
								?>
								<form method="post" action="emailSignupStep2.php">
								<table>
								  <tr><td>Email Address</td><td><input type="text" name="email" size="20" class="darkgray" value="<?php echo $username; ?>"> @visionsystems.tv</td></tr>
								  <tr><td>Name</td><td><input type="text" name="name" size="20" class="darkgray" value="<?php echo $name; ?>"></td></tr>
								  <tr><td>Password</td><td><input type="password" name="password" size="10" class="darkgray"> minimum 6 characters</td></tr>
								  <tr><td>Retype Password</td><td><input type="password" name="password2" size="10" class="darkgray"></td></tr>
								  <tr><td>Secret Question</td><td><select name="secretq" class="darkgray">
									<option value="pet" selected>Favorite pet's name?</option>
									<option value="movie">Favorite movie?</option>
									<option value="anni">Anniversary [mm/dd/yy]?</option>
									<option value="father">Father's middle name?</option>
									<option value="spouse">Spouse's middle name?</option>
									<option value="child">First child's middle name?</option>
									<option value="hschool">High school name?</option>
									<option value="teacher">Favorite teacher's name?</option>
									<option value="sports">Favorite sports team?</option>
								  </select></td></tr>
								  <tr><td>Secret Answer</td><td><input type="text" name="secreta" size="20" class="darkgray" value="<?php echo $secreta; ?>"></td></tr>
								  <tr>
