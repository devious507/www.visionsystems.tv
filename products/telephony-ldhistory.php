					...
					<tr>
						...
						<table cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<img src="../images/spacer.gif" alt="" height="1" width="5"> Long Distance History<br>
								<img src="../images/spacer.gif" alt="" height="1" width="5"> <a href="telephony-international.php">International Rates</a><br>
						...
						<table cellpadding="2" cellspacing="0" border="0" width="367">
							<tr>
								...
								<table cellpadding=0 cellspacing=1 border=0 width="353" bgcolor="#AAAAAA">
									<tr>
										...
										<table cellpadding=5 cellspacing=0 border=0 width="351" bgcolor="#FFFFE5">
											<tr>
												<td class="content" align="center"><b>Long Distance History</b></td>
											</tr>
										</table>
										</td>
									</tr>
								...
								<br>
								Please login below to view your long distance history. Your Account ID is located
								on your <a href="../bill-explanation.html">bill</a>.<br>
								<br>
								Please enter your complete phone number, including area code.<br>
								<br>
								<form method="get" action="ldhistory2.php">
								<center>
								
                          		<table cellpadding=2 cellspacing=0 border=0>
									<tr>
										<td class="content" align="right">Phone Number:</td>
										<td class="content"><input type="text" name="inphone" class="input" size="30"></td>
									</tr>
									<tr>
										<td class="content" align="right">Account ID:</td>
										<td class="content"><input type="text" name="account" class="input" size="30"></td>
									</tr>
									<tr>	
                                		<td colspan="2" align="right">
										<input value="Login" type="image" src="../images/sub-login.gif" alt="Login">
										</td>
									</tr>
								</table>
								</center>
